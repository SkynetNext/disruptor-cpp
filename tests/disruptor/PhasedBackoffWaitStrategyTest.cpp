...
TEST(PhasedBackoffWaitStrategyTest, shouldHandleImmediateSequenceChange) {
  auto ws1 = disruptor::PhasedBackoffWaitStrategy<disruptor::BlockingWaitStrategy>::withLock(
    1'000'000, 1'000'000);
  auto ws2 = disruptor::PhasedBackoffWaitStrategy<disruptor::SleepingWaitStrategy>::withSleep(
    1'000'000, 1'000'000);
