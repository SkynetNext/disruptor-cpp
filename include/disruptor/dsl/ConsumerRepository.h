...
public:
  ...
  void startAll(ThreadFactory& threadFactory, std::latch* startupLatch = nullptr) {
...
private:
  ...
  EventProcessorInfo<BarrierPtrT>* getEventProcessorInfo(EventHandlerIdentity& handlerIdentity) {
  ...
  ConsumerInfo<BarrierPtrT>* getEventProcessorInfo(Sequence& barrierEventProcessor) {
